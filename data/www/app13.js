...
document.addEventListener("submit",async e=>{
  ...
  if(f.id=="mailDailyForm"){e.preventDefault();await runSeq(["ntp kick",`cron add daily ${field(f,"time","08:00")} mail health ${q(field(f,"subject","KernelESP daily health"))}`,"crontab -l"],o);return}
