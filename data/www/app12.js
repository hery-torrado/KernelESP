...
<div class="grid">
<section class="card"><h2>Daily Health Email</h2><form id="mailDailyForm"><input name="time" type="time" value="08:00"><input name="subject" value="KernelESP daily health"><button>Add Daily Job</button></form><div class="quick"><button data-cmd="crontab -l">Cron Entries</button></div><pre class="formOut"></pre></section>
